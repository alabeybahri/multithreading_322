...
int main(int argc, char *argv[]) {
    ...
    pthread_t tid9;
    pthread_t tid10;
    pthread_create(&tid, NULL, calculateMaximum, NULL);
    pthread_create(&tid2, NULL, calculateMinimum, NULL);
    pthread_create(&tid3, NULL, calculateRange, NULL);
    pthread_create(&tid4, NULL, calculateMode, NULL);
    pthread_create(&tid5, NULL, calculateMedian, NULL);
    pthread_create(&tid6, NULL, calculateSum, NULL);
    pthread_create(&tid7, NULL, calculateArithmeticMean, NULL);
    pthread_create(&tid8, NULL, calculateHarmonicMean, NULL);
    pthread_create(&tid9, NULL, calculateStandardDeviation, NULL);
    pthread_create(&tid10, NULL, calculateInterquartileRange, NULL);
